...
public class test {
   public static void main(String[] args){
	   // training files dir and model path
	   String[] trainArgs = {"a1a.txt"};
	   // testing data file path, model path , output file path
	   String[] testArgs = {"a1a.test.txt","a1a.txt.model","text_output.txt"};
       try {
